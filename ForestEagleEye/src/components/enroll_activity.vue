        ...
        <div class="activity-details">
          ...
          <form @submit.prevent="handleSubmit" class="enroll-form">
            <div class="form-item1">
              ...
              <el-input-number v-model="participantNumber" :min="1" :max="remainingSlots" placeholder="请输入报名人数" />
            </div>
            <div class="form-item">
              <label for="remark" class="remark-label">备注:</label>
              <el-input type="textarea" v-model="remark" rows="4" placeholder="请输入备注（可选）" />
            </div>
