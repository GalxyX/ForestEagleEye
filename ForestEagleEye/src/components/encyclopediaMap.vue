...
<template>
    <el-tabs type="border-card" v-model="activeTab">
        <el-tab-pane label="世界林木覆盖" name="treeCover">
            <el-alert
                title="小知识：林木覆盖是指地球上被林木覆盖的总面积，通常以百分比或平方公里为单位来表示。它反映了全球森林资源的分布情况和森林生态系统在全球范围内的覆盖程度。"
                type="warning"
                :closable="false"
                style="font-size: small;width: 1250px;">
            </el-alert>
        ...
        <el-tab-pane label="世界原生林" name="primevalTree">
            <el-alert
                title="小知识：原生林是指未经人为干扰或经过长期自然恢复后，保持自然演替过程和生态结构完整的森林。它具有丰富的生物多样性、稳定的生态系统功能和独特的自然景观特征。"
                type="warning"
                :closable="false"
                style="font-size: small;width: 1250px;">
            </el-alert>
        ...
        <el-tab-pane label="世界土壤有机碳" name="organicCarbon">
            <el-alert
                title="小知识：土壤有机碳是指土壤中以有机形式存在的碳元素，主要来源于植物残体、动物遗骸和微生物的代谢产物。它是土壤有机质的重要组成部分，对土壤肥力和生态系统碳循环具有重要影响。"
                type="warning"
                :closable="false"
                style="font-size: small; width: 1250px;">
            </el-alert>
        ...
        <el-tab-pane label="世界森林火灾" name="ForestFire">
            <el-alert
                title="小知识：森林火灾是指在森林中发生的火灾，通常由自然因素或人为因素引起。它会导致森林植被的破坏、生物多样性的损失以及土壤和水文条件的改变。"
                type="warning"
                :closable="false"
                style="font-size: small;width: 1250px;">
            </el-alert>
        ...
        <el-tab-pane label="世界存活林木生物量" name="BiomassCO2">
            <el-alert
                title="小知识：林木生物量是指森林中所有林木的总重量，通常以干重（去除水分后的重量）来计算。它反映了森林生态系统中林木的生长状况和生产力水平。"
                type="warning"
                :closable="false"
                style="font-size: small;width: 1250px;">
            </el-alert>
