              ...
              <div class="container">
                ...
                <div style="display: flex; gap: 50px;">
                  ...
                  <div style="display: flex; flex-direction: column;margin-left:50px;">
                    ...
                    <text style="font-size: xx-small; color: grey;">全球国家和地区森林覆盖面积(2010~2024) from Global Forest
                      Watch,使用鼠标与数据互动</text>
                  </div>
                  <!--森林百科简介-->
                  <div style="display: flex; flex-direction: column; width: 380px; margin-top: 20px;">
                    ...
                    <text style="color: grey;line-height: 1.5; font-family: Georgia, 'Times New Roman', Times, serif;">
                      Get global forest data from the Forest Encyclopedia of ForestEagleEye. Query single points,
                      compare
                      multiple, and view accurate visualizations.
                    </text>
                    <el-button class="try-btn" type="success" plain style="margin-top: 20px;"
                      @click="scrolldown">立即体验</el-button>
                  </div>
                </div>
                <!--森林百科功能详细介绍-->
                <div style="margin-left: 80px; margin-top: 50px;">
                  ...
                  <div style="display: flex; gap: 30px; align-items: center;">
                    ...
                    <div style="display: block; width: 700px;">
                      <h5>
                        林上鹰眼为您提供全球森林资源的详尽数据，涵盖森林覆盖率、森林生物量等多个关键指标，力求全面、准确地反映全球森林资源的现状与变化趋势。通过这些数据，您可以了解不同国家和地区的森林资源分布情况，掌握全球森林资源的总量与结构，为相关研究、决策提供有力的数据支持。
                      </h5>
                      <h6>Forest Eagle Eye delivers comprehensive global forest data, covering forest cover and biomass,
                        to
                        provide a clear picture of current forest resources and trends. This data aids in understanding
                        forest
                        distribution worldwide and supports informed decision-making and research.</h6>
                    </div>
                  </div>
                  ...
                  <div style="display: flex; gap: 30px; align-items: center;">
                    <div style="display: block; width: 700px; ">
                      <h5>
                        林上鹰眼详细呈现自建数据库中各林区的资源类型、气候资源、生物多样性等关键信息。通过深入了解主要林区的数据详情，您可以更好地认识不同林区的独特性和面临的挑战，为保护和可持续利用森林资源提供科学依据。
                      </h5>
                      <h6>Our platform offers in-depth insights into various forest areas, detailing resource types,
                        climate,
                        and biodiversity. This helps you recognize the unique characteristics and challenges faced by
                        different
                        forest regions, supporting efforts to protect and sustainably manage these vital ecosystems.
                      </h6>
                    </div>
                  ...
                  <div style="display: flex; gap: 30px; align-items: center;">
                    ...
                    <div style="display: block; width: 700px;">
                      <h5>
                        林上鹰眼提供丰富的数据可视化比较功能。通过图表、地图、动画等多种可视化手段，将复杂的森林资源数据进行直观展示和对比。您可以根据自己的需求选择不同的数据维度和可视化形式，轻松实现数据的对比分析，快速发现数据背后的规律和趋势，为决策和研究提供更直观的参考依据。
                      </h5>
                      <h6>With our data visualization tools, complex forest data is made accessible through charts,
                        maps, and
                        animations. Easily compare and analyze data across different dimensions, quickly identifying
                        patterns
                        and trends to inform your research and decision-making processes.</h6>
                    </div>
                  </div>
                </div>
